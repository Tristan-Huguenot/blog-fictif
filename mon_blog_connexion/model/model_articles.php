<?php
     ...
     */
    function billet(PDO $bdd, int $id = NULL, bool $ascend = false){
        ...
        $sql .= (!$ascend) ? ' ORDER BY billets.date_creation DESC' : '';
     ...
     */
    function commentairesBillet(PDO $bdd, int $id, bool $ascend = false){
        ...
        $sql .= (!$ascend) ? ' ORDER BY commentaires.date_commentaire DESC' : '';
